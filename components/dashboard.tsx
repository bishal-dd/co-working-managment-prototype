      ...
      <div className="grid grid-cols-1 2xl:grid-cols-2 gap-4 lg:gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest workspace and meeting room reservations
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  type: "warning",
                  message: "HVAC maintenance scheduled for tomorrow 8 AM",
                  time: "2 hours ago",
                },
                {
                  type: "info",
                  message: "New member registration: Dorji Tshering",
                  time: "4 hours ago",
                },
                {
                  type: "error",
                  message: "Access card reader malfunction in Room B",
                  time: "6 hours ago",
                },
                {
                  type: "success",
